...
app_include_css = [
	"/assets/bigtech_theme/css/bigtech_theme.css?v={}".format(time.time()),
	"/assets/bigtech_theme/css/language_switcher.css?v={}".format(time.time()),
]
app_include_js = [
	"/assets/bigtech_theme/js/bigtech_theme.js?v={}".format(time.time()),
	"/assets/bigtech_theme/js/language_switcher.js?v={}".format(time.time()),
]
