frappe.provide("bigtech_theme.language");

bigtech_theme.language.languages = [
    {
        code: "en",
        label: "English",
        flag: "🇺🇸"
...
bigtech_theme.language.initialized = false;
...
function wait_for_toolbar_user() {
    const interval = setInterval(() => {
        ...
        if ($toolbar.length && !bigtech_theme.language.initialized) {
            clearInterval(interval);
            bigtech_theme.language.initialized = true;
...
function render_language_submenu($toolbar) {
    ...
    const $submenu = $(`
        ...
        ">
            ${bigtech_theme.language.languages.map(lang => {
